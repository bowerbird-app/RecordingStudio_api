...
class DocsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "config page renders successfully" do
    ...
    assert_includes response.body, "config.rate_limit_api_enabled = Rails.env.production?"
    ...
    assert_includes response.body, "config.rate_limit_fail_closed_buckets = %w[oauth api_pre_auth]"
