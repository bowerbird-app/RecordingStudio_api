...
class DocsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "api routes page renders successfully" do
    with_recordable_types_and_actions(
      ...
      assert_includes response.body, "recording_studio_admin_for :api, at: &quot;/api/dashboard&quot;"
      assert_includes response.body, "recording_studio_admin_for :admin, at: &quot;/admin&quot;"
      ...
      assert_includes response.body, "GET /admin/screens/api_logs"
