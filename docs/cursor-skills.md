...
The gemspec packages only `app`, `config`, `db`, and `lib`, plus changelog,
license, Rakefile, README, and upgrading notes. Cursor boot files and generated
pack files do not ship in the gem.
