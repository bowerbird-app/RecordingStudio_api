...
11. Register host endpoints that are not a recordable with `RecordingStudioApi.register_endpoint`. Do not add a fake recordable or a one-off API controller.
