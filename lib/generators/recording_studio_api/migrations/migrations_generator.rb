...
module RecordingStudioApi
  module Generators
    # Generator to install RecordingStudioApi migrations into the host application.
    #
    # Usage:
    #   rails generate recording_studio_api:migrations
    #
    # Options:
    ...
    class MigrationsGenerator < Rails::Generators::Base
      ...
      desc "Copy RecordingStudioApi migrations to your application"
      ...
      def copy_migrations
        ...
        unless File.directory?(migrations_dir)
          say "No migrations found in RecordingStudioApi engine.", :yellow
          return
        end
        ...
        migration_files.each do |source_path|
          ...
          # Extract migration name without timestamp (e.g., "create_recording_studio_api_pages.rb")
