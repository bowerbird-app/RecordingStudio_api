  ...
  module Admin
    module AdminApiClientErrorsLastFourWeeksWidget
      ...
      Definition = ::RecordingStudioAdmin::Widget.new(
        ...
        chart_type :area
        series { RecordingStudioApi::Admin::AdminApiClientErrorsLastFourWeeksWidget.series }
        chart_options do
          {
            height: 240,
      ...
      def daily_points
        ...
        counts.merge!(RecordingStudioApi::Admin::ApiRequestLogHelpers.daily_metric_counts(start_date: buckets.first, end_date: buckets.last, status_class: 4))
      ...
      def metric_total_for(range)
        RecordingStudioApi::Admin::ApiRequestLogHelpers.metric_total(start_date: range.begin.to_date, end_date: range.end.to_date, status_class: 4)
      end
    end
  end
end