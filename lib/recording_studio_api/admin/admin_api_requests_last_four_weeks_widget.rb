  ...
  module Admin
    module AdminApiRequestsLastFourWeeksWidget
      ...
      Definition = ::RecordingStudioAdmin::Widget.new(
        ...
        chart_type :area
        series { |context| RecordingStudioApi::Admin::AdminApiRequestsLastFourWeeksWidget.series(context) }
        chart_options do
          {
            height: 240,
      ...
      def daily_points(context = nil)
        ...
        counts.merge!(RecordingStudioApi::Admin::ApiRequestLogHelpers.daily_metric_counts(start_date: buckets.first, end_date: buckets.last, api: api_key(context)))
      ...
      def metric_total_for(range, context = nil)
        RecordingStudioApi::Admin::ApiRequestLogHelpers.metric_total(start_date: range.begin.to_date, end_date: range.end.to_date, api: api_key(context))
      end
